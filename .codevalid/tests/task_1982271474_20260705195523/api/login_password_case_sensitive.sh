...
USER_ID="user-password-case-${CASE_SUFFIX}"
USER_EMAIL="customer-${CASE_SUFFIX}@test.com"
RESPONSE_FILE="/tmp/login_password_case_sensitive_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/login_password_case_sensitive_${CASE_SUFFIX}.status"
...
db.users.push({ id: userId, name: 'Customer Password Case', email, password: 'SecurePass123', role: 'customer' });
...
echo "CODEVALID_TEST_ASSERTION_OK:login_password_case_sensitive"
