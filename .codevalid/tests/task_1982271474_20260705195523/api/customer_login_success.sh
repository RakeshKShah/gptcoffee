...
USER_ID="user-customer-${CASE_SUFFIX}"
USER_EMAIL="customer-${CASE_SUFFIX}@test.com"
RESPONSE_FILE="/tmp/customer_login_success_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/customer_login_success_${CASE_SUFFIX}.status"
...
grep -F '"email":' "$RESPONSE_FILE" >/dev/null
...
echo "CODEVALID_TEST_ASSERTION_OK:customer_login_success"
